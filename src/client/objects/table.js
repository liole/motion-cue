...
Table.snooker = new Table('#228b22', {
    color: '#006400',
    points: [{ x: 2.91, y: 1.5 }, { x: 4.91, y: 3 }, { x: 47.5, y: 3 }, { x: 49, y: 1.5 }, { x: 49, y: 0.5 }, { x: 51, y: 0.5 },
        { x: 51, y: 1.5 }, { x: 52.5, y: 3 }, { x: 95.09, y: 3 }, { x: 97.09, y: 1.5 }, { x: 97.09, y: 1 }, { x: 99, y: 1 }, { x: 99, y: 2.91 },
        { x: 98.5, y: 2.91 }, { x: 97, y: 4.91 }, { x: 97, y: 45.09 }, { x: 98.5, y: 47.09 }, { x: 99, y: 47.09 }, { x: 99, y: 49 }, { x: 97.09, y: 49 },
        { x: 97.09, y: 48.5 }, { x: 95.09, y: 47 }, { x: 52.5, y: 47 }, { x: 51, y: 48.5 }, { x: 51, y: 49.5 }, { x: 49, y: 49.5 },
        { x: 49, y: 48.5 }, { x: 47.5, y: 47 }, { x: 4.91, y: 47 }, { x: 2.91, y: 48.5 }, { x: 2.91, y: 49 }, { x: 1, y: 49 }, { x: 1, y: 47.09 },
        { x: 1.5, y: 47.09 }, { x: 3, y: 45.09 }, { x: 3, y: 4.91 }, { x: 1.5, y: 2.91 }, { x: 1, y: 2.91 }, { x: 1, y: 1 }, { x: 2.91, y: 1 } ]
}, {
    color: '#4a2106',
    x: 0.75, y: 0.75,
